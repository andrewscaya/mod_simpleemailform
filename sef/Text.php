 ...
 */
require_once MOD_SIMPLEEMAILFORM_DIR . DIRECTORY_SEPARATOR . 'sef' . DIRECTORY_SEPARATOR . 'PEAR.php';
...
class ImageText
{
    ...
    public $_reInits = array('width', 'height', 'canvas', 'angle', 'font_file', 'font_path', 'font_size');
    ...
    public $_realTextSize = array('width' => false, 'height' => false);
     ...
     * it to this public function. Multiple colors will be
